import 'package:berita_flutter/models/article_model.dart';
import 'package:berita_flutter/models/news_model.dart';
...
class NewsController extends GetxController {
  ...
  getNews({channel = '', searchKey = '', reload = false}) async {
    ...
    baseApi += 'apikey=9d456d85b876469fa6ca0d1f137973ea';
    ...
    if (channel != '') {
      ...
      baseApi =
          "https://newsapi.org/v2/top-headlines?pageSize=10&page=$pageNum&sources=$channel&apikey=9d456d85b876469fa6ca0d1f137973ea";
    }
    ...
    if (searchKey != '') {
      ...
      baseApi =
          "https://newsapi.org/v2/top-headlines?pageSize=10&page=$pageNum&q=$searchKey&apikey=9d456d85b876469fa6ca0d1f137973ea";
    }
    print(baseApi);
